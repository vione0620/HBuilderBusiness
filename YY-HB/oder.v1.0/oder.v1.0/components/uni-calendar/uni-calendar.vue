<template>
	<view class="uni-calendar">
		...
		<view v-if="insert || show" class="uni-calendar__content" :class="{'uni-calendar--fixed':!insert,'uni-calendar--ani-show':aniMaskShow}">
			...
			<!-- 	<template v-if="!yesterday">
					<text class="uni-calendar__backtoday" @click="backtoday">回到今天</text>
				</template> -->
				<!-- <text class="uni-calendar__backtoday" @click="backtoday">{{ ? '回到当前' : '回到今天'}}</text> -->
			...
			<view class="uni-calendar__box">
				...
				<view class="uni-calendar__weeks" v-for="(item,weekIndex) in weeks" :key="'4'+weekIndex">
					<view class="uni-calendar__weeks-item" v-for="(weeks,weeksIndex) in item" :key="'4'+weeksIndex">
